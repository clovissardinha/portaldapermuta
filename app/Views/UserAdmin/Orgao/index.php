...
<div class="card  ">
    ...
    <p class="text-center text-uppercase pt-5"><strong> Pesquisa por Órgão </strong></p> 
    </div>
    <div class="conteiner border ">
        <div class="card-body col-sm-4 m-auto">
        <form action="<?php echo base_url('UserAdmin/PesquisaOrgao/buscarOrgao') ?>", method="get
        ">
                <div class="form-group">
                                <label for="orgao"></label>
                                <small id="helpId" class="font-weight-bold">orgao</small>  
